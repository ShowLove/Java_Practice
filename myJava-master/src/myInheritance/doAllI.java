...
import myInterface.Google;
import myInterface.Harris;
import myInterface.TexasInstruments;
...
public class doAllI {
	...
	public static void main(String args[]){
		...
		HarrisI harris =  new HarrisI(); 
		CompanyI ti = new TexasInstrumentsI(); 
		GoogleI google = new GoogleI(); 
		...
		CompanyI[] companyList = new CompanyI[] { harris, google, ti }; 
